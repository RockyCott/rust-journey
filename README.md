...
- `fundamentals/` — Basic concepts: variables, ownership, borrowing, lifetimes, functions.
- `intermediate/` — Enums, pattern matching, error handling, standard library exploration.
- `advanced/` — Traits, smart pointers, lifetimes, macros, async programming.
- `projects/` — Full Rust projects like CLI tools, small web servers, games, and more.
- `challenges/` — Coding challenges to reinforce understanding, with instructions.
- `playground/` — Quick tests or prototypes while experimenting with ideas.
- `notes/` — Markdown summaries and personal notes on what I’ve learned.

## 🚀 Motivation

Rust is a powerful systems programming language that guarantees memory safety and concurrency without a garbage collector. This repository documents my journey in mastering it, and serves both as a learning path and a resource for others who might be on the same path.
...
- Optional: `cargo-edit`, `clippy`, `rustfmt` for development
